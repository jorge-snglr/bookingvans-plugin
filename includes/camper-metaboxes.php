  ...
  function camper_deatils_box( $camper_data ) {
    ...
    ?>
      ...
      <tbody>
        <tr>
          <th scope="row">
            <label for="camper-details-solar-panels"><?php echo esc_html_x( 'Solar panels', 'camper-single', 'mybooking-campers' ) ?></label>
          </th>
          <td style="width: 90%;">
             <input
              type="checkbox"
              ...
              class="components-text-control__input">
              <?php echo esc_html_x( 'Solar panels included', 'camper-single', 'mybooking-campers' ) ?></label>
          </td>
        </tr>
      </table>
