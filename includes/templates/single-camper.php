    	...
    	<div class="post_content mybooking-campers mybooking-campers_post">
    		<div class="mb-container" tabindex="-1">
                  ...
                  <?php if ( $camper_details_solar_panels == 'yes' ) {  ?>
                    <span class="mybooking-campers_characteristic">
                      <img class="mybooking-campers_characteristic-icon" alt="<?php echo esc_html_x( 'Solar panels', 'camper-single', 'mybooking-campers' ) ?>" title="<?php echo esc_html_x( 'Solar panels', 'camper-single', 'mybooking-campers' ) ?>" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/icons/solar-panels.svg'; ?>">
                      <?php echo esc_html_x( 'Yes', 'camper-single', 'mybooking-campers' ) ?>
                    </span>
                  <?php } ?>
